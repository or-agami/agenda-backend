  ...
  !(function () {
      ...
      return (
        ...
        (E.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              (s.type = e), (s.arg = t), i ? ((this.method = 'next'), (this.next = i.finallyLoc), f) : this.complete(s)
            )
          },
            ...
            function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 3:
                    return (s = Object.assign(Object.assign({}, a), { ignoreSearch: !0 })), (e.next = 6), t.keys(r, s)
                  case 6:
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                ...
                case 4:
                  if (
                    ((i = t.clone()),
                    (s = { headers: new Headers(i.headers), status: i.status, statusText: i.statusText }),
                    (c = r ? r(s) : s),
                    !P())
                  ) {
                    e.next = 11
    ...
    function Z(e) {
      return e !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
        ? (
            V ||
            (V = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])
          ).includes(e)
          ? function () {
    ...
    function ee(e) {
      return 'function' === typeof e
        ...
        : (e instanceof IDBTransaction &&
          ...
          (t = e),
          (G || (G = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(function (e) {
    ...
    function ce(e, t) {
      if (e instanceof IDBDatabase && !(t in e) && 'string' === typeof t) {
        ...
        var r = t.replace(/FromIndex$/, ''),
          n = t !== r,
          a = ie.includes(r)
        if (r in (n ? IDBIndex : IDBObjectStore).prototype && (a || ae.includes(r))) {
          var i = (function () {
            var e = E(
              _().mark(function e(t) {
                var i,
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          for (
                            s = this.transaction(t, a ? 'readwrite' : 'readonly'),
                              c = s.store,
                              o = f.length,
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 4:
                              return (
                                (a = e.sent),
                                (i = a.transaction(oe, 'readwrite', { durability: 'relaxed' })),
                                (e.next = 8),
                                i.store.put(n)
                              )
                            case 8:
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 2:
                              return (
                                (n = e.sent),
                                (e.next = 5),
                                n.transaction(oe).store.index('timestamp').openCursor(null, 'prev')
                              )
                            case 5:
                              ;(a = e.sent), (i = []), (s = 0)
                            case 8:
                              ...
                              return (
                                (c = a.value).cacheName === this._cacheName &&
                                  ((t && c.timestamp < t) || (r && s >= r) ? i.push(a.value) : s++),
                                (e.next = 13),
                                a.continue()
                              )
                            case 13:
                            ...
                            case 18:
                              ...
                              return (f = h[u]), (e.next = 22), n.delete(oe, f.id)
                            case 22:
                              o.push(f.url)
                            case 23:
                              u++, (e.next = 18)
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ...
                              return (
                                (e.next = 3),
                                ne('workbox-expiration', 1, { upgrade: this._upgradeDbAndDeleteOldDbs.bind(this) })
                              )
                            case 3:
                              this._db = e.sent
                            case 4:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 14:
                              ...
                              return (s = i.value), (e.next = 18), n.delete(s, this._matchOptions)
                            case 18:
                              e.next = 14
                              break
                            case 20:
                            ...
                            case 28:
                              0,
                                (this._isRunning = !1),
                                this._rerunRequested && ((this._rerunRequested = !1), q(this.expireEntries()))
                            case 31:
                            case 'end':
                              return e.stop()
                          }
              ...
              _().mark(function e(r) {
                ...
                return _().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((n = r.event), (a = r.request), (i = r.cacheName), (s = r.cachedResponse))) {
                          e.next = 3
                          break
                        }
                  ...
                  return _().wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            ;(t = O(this._cacheExpirations)), (e.prev = 1), t.s()
                          case 3:
                            if ((r = t.n()).done) {
                              e.next = 11
                              break
                            }
                            return (n = le(r.value, 2)), (a = n[0]), (i = n[1]), (e.next = 7), self.caches.delete(a)
                          case 7:
    ...
    function de(e) {
      ...
      return a.searchParams.set('__WB_REVISION__', r), { cacheKey: a.href, url: i.href }
    }
    var ye = n(function e() {
        var t = this
        a(this, e),
                      ...
                      case 0:
                        return (
                          ...
                          'install' === n.type &&
                            ...
                            ((s = a.originalRequest.url), i ? t.notUpdatedURLs.push(s) : t.updatedURLs.push(s)),
                          e.abrupt('return', i)
                        )
                      case 3:
                      case 'end':
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (a = t.params),
                          (i =
                            (null === a || void 0 === a ? void 0 : a.cacheKey) ||
                            r._precacheController.getCacheKeyForURL(n.url)),
                          e.abrupt('return', i ? new Request(i, { headers: n.headers }) : n)
                        )
                      case 3:
                      case 'end':
                        return e.stop()
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ((r = this.event),
                                  !('navigate' === (n = ge(t)).mode && r instanceof FetchEvent && r.preloadResponse))
                                ) {
                                  e.next = 9
                                  break
                                }
                              ...
                              case 9:
                                ;(i = this.hasCallback('fetchDidFail') ? n.clone() : null),
                                  (e.prev = 10),
                                  (s = O(this.iterateCallbacks('requestWillFetch'))),
                                  (e.prev = 12),
                                  s.s()
                              case 14:
                                if ((c = s.n()).done) {
                                ...
                                return (o = c.value), (e.next = 18), o({ request: n.clone(), event: r })
                              case 18:
                                n = e.sent
                              case 19:
                                e.next = 14
                              ...
                              case 31:
                                ...
                                throw new d('plugin-error-request-will-fetch', { thrownErrorMessage: e.t1.message })
                              case 35:
                                return (
                                  (u = n.clone()),
                                  (e.prev = 36),
                                  (e.next = 39),
                                  fetch(n, 'navigate' === n.mode ? void 0 : this._strategy.fetchOptions)
                                )
                              case 39:
                                ;(h = e.sent), (f = O(this.iterateCallbacks('fetchDidSucceed'))), (e.prev = 42), f.s()
                              case 44:
                                if ((l = f.n()).done) {
                                  e.next = 51
                                  break
                                }
                                return (p = l.value), (e.next = 48), p({ event: r, request: u, response: h })
                              case 48:
                                h = e.sent
                              case 49:
                                e.next = 44
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 4:
                              return (
                                (c = e.sent),
                                (o = Object.assign(Object.assign({}, s), { cacheName: i })),
                                (e.next = 8),
                                caches.match(c, o)
                              )
                            case 8:
                              ;(n = e.sent),
                                (u = O(this.iterateCallbacks('cachedResponseWillBeUsed'))),
                                (e.prev = 11),
                                u.s()
                            case 13:
                              if ((h = u.n()).done) {
                              ...
                              return (
                                (f = h.value),
                                (e.next = 17),
                                f({ cacheName: i, matchOptions: s, cachedResponse: n, request: c, event: this.event })
                              )
                            case 17:
                              if (((e.t0 = e.sent), e.t0)) {
                                e.next = 20
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 11:
                              ...
                              throw new d('cache-put-with-no-response', { url: I(i.url) })
                            case 14:
                            ...
                            case 23:
                              ...
                              return (t.next = 28), S(f, i.clone(), ['__WB_REVISION__'], h)
                            case 28:
                            ...
                            case 31:
                              t.t0 = null
                            case 32:
                              return (p = t.t0), (t.prev = 34), (t.next = 37), f.put(i, l ? c.clone() : c)
                            case 37:
                              t.next = 46
                              break
                            case 39:
                            ...
                            case 45:
                              throw t.t1
                            case 46:
                              ;(v = O(this.iterateCallbacks('cacheDidUpdate'))), (t.prev = 47), v.s()
                            case 49:
                              if ((y = v.n()).done) {
                                t.next = 55
                                break
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ...
                              ;(a = t), (i = O(this.iterateCallbacks('cacheKeyWillBeUsed'))), (e.prev = 4), i.s()
                            case 6:
                              if ((s = i.n()).done) {
                                e.next = 15
                                break
                              ...
                              return (
                                ...
                                (e.t0 = ge),
                                (e.next = 11),
                                c({ mode: r, request: a, event: this.event, params: this.params })
                              )
                            case 11:
                    ...
                    return _().wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ;(n = O(this.iterateCallbacks(t))), (e.prev = 1), n.s()
                            case 3:
                              if ((a = n.n()).done) {
                                e.next = 9
                                break
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      ...
                                      return (
                                        ...
                                        (s = function (e) {
                                          var n = Object.assign(Object.assign({}, e), { state: a })
                                          return r[t](n)
                                        }),
                                        (e.next = 6),
                                        s
                    ...
                    return _().wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ;(r = t), (n = !1), (a = O(this.iterateCallbacks('cacheWillUpdate'))), (e.prev = 3), a.s()
                            case 5:
                              if ((i = a.n()).done) {
                                e.next = 18
                                break
                              ...
                              return (
                                (s = i.value),
                                (e.next = 9),
                                s({ request: this.request, response: r, event: this.event })
                              )
                            case 9:
                              if (((e.t0 = e.sent), e.t0)) {
                                e.next = 12
                    ...
                    return _().wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), t.runCallbacks('handlerWillStart', { event: n, request: r })
                            case 2:
                            ...
                            case 11:
                              ...
                              ;(i = O(t.iterateCallbacks('handlerDidError'))), (e.prev = 15), i.s()
                            case 17:
                              if ((s = i.n()).done) {
                                e.next = 26
                                break
                              }
                              return (c = s.value), (e.next = 21), c({ error: e.t0, event: n, request: r })
                            case 21:
                              if (!(a = e.sent)) {
                                e.next = 24
                                break
                            ...
                            case 38:
                              0
                            case 39:
                              ;(o = O(t.iterateCallbacks('handlerWillRespond'))), (e.prev = 40), o.s()
                            case 42:
                              if ((u = o.n()).done) {
                                e.next = 49
                                break
                              }
                              return (h = u.value), (e.next = 46), h({ event: n, request: r, response: a })
                            case 46:
                              a = e.sent
                            case 47:
                              e.next = 42
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 8:
                              return (
                                (e.prev = 8),
                                (e.next = 11),
                                r.runCallbacks('handlerDidRespond', { event: a, request: n, response: i })
                              )
                            case 11:
                            ...
                            case 13:
                              ...
                              break
                            case 15:
                              ;(e.prev = 15), (e.t1 = e.catch(8)), e.t1 instanceof Error && (s = e.t1)
                            case 18:
                              return (
                                (e.next = 20),
                                r.runCallbacks('handlerDidComplete', { event: a, request: n, response: i, error: s })
                              )
                            case 20:
                              if ((r.destroy(), !s)) {
                                e.next = 23
      ...
      we = (function (t) {
        ...
        function i() {
          ...
          return (
            ...
            ((e = r.call(this, t))._fallbackToNetwork = !1 !== t.fallbackToNetwork),
                    ...
                    return _().wrap(
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (((i = n.params || {}), !this._fallbackToNetwork)) {
                                t.next = 17
                                break
                              }
                              return (
                                ...
                                (o = !c || c === s),
                                (t.next = 8),
                                n.fetch(new Request(r, { integrity: 'no-cors' !== r.mode ? c || s : void 0 }))
                              )
                            case 8:
                              if (((a = t.sent), !s || !o || 'no-cors' === r.mode)) {
                                t.next = 15
                                break
                              }
                              return (
                                this._useDefaultCacheabilityPluginIfNeeded(), (t.next = 13), n.cachePut(r, a.clone())
                              )
                            case 13:
                              t.sent
                            case 15:
                              ...
                              break
                            case 17:
                              throw new d('missing-precache-entry', { cacheName: this.cacheName, url: r.url })
                            case 18:
                              t.next = 34
                              break
                            case 23:
                            ...
                            case 24:
                              ;(u = t.t0),
                                e.groupCollapsed('Precaching is responding to: ' + I(r.url)),
                                e.log('Serving the precached url: '.concat(I(u instanceof Request ? u.url : u))),
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 6:
                              ...
                              throw new d('bad-precaching-response', { url: t.url, status: n.status })
                            case 9:
                              return e.abrupt('return', n)
                            case 10:
                            case 'end':
                ...
                try {
                  for (n.s(); !(e = n.n()).done; ) {
                    ...
                    c !== i.copyRedirectedCacheableResponsesPlugin &&
                      (c === i.defaultPrecacheCacheabilityPlugin && (t = s), c.cacheWillUpdate && r++)
                  }
                } catch (o) {
                  n.e(o)
                } finally {
              ...
              value: function (e) {
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    if (this._urlsToCacheKeys.has(c) && this._urlsToCacheKeys.get(c) !== s)
                    ...
                    if ('string' !== typeof a && a.integrity) {
                      if (this._cacheKeysToIntegrities.has(s) && this._cacheKeysToIntegrities.get(s) !== a.integrity)
                        throw new d('add-to-cache-list-conflicting-integrities', { url: c })
                      this._cacheKeysToIntegrities.set(s, a.integrity)
                    }
                    if ((this._urlsToCacheKeys.set(c, s), this._urlsToCacheModes.set(c, o), r.length > 0)) {
                      var u =
                            ...
                            switch ((r.prev = r.next)) {
                              ...
                              case 5:
                                ...
                                return (
                                  ...
                                  (f = new Request(c, { integrity: u, cache: h, credentials: 'same-origin' })),
                                  (r.next = 12),
                                  Promise.all(t.strategy.handleAll({ params: { cacheKey: o }, request: f, event: e }))
                                )
                              case 12:
                                r.next = 5
                                break
                              ...
                              case 22:
                                return (
                                  (l = n.updatedURLs),
                                  (p = n.notUpdatedURLs),
                                  r.abrupt('return', { updatedURLs: l, notUpdatedURLs: p })
                                )
                              case 25:
                              case 'end':
                                return r.stop()
    ...
    var Ee,
      ...
      Oe = (function () {
        function e(t, r) {
          ...
          a(this, e), (this.handler = Ce(r)), (this.match = t), (this.method = n)
        }
        return (
          n(e, [
            {
              ...
              value: function (e) {
                ...
                if (a.protocol.startsWith('http')) {
                  var i = a.origin === location.origin,
                    s = this.findMatchingRoute({ event: n, request: r, sameOrigin: i, url: a }),
                    c = s.params,
                    o = s.route,
                    u = o && o.handler
                  0
                  var h = r.method
                  if ((!u && this._defaultHandlerMap.has(h) && (u = this._defaultHandlerMap.get(h)), u)) {
                    var f
                    0
                    try {
                                      ...
                                      switch ((e.prev = e.next)) {
                                        case 0:
                                          ...
                                          return (
                                            (e.prev = 2),
                                            (e.next = 5),
                                            l.handle({ url: a, request: r, event: n, params: c })
                                          )
                                        case 5:
                                          return e.abrupt('return', e.sent)
                                        case 8:
                                          ;(e.prev = 8), (e.t0 = e.catch(2)), e.t0 instanceof Error && (i = e.t0)
                                        case 11:
                                          if (!t._catchHandler) {
                                            e.next = 14
                                            break
                                          ...
                                          return e.abrupt(
                                            'return',
                                            t._catchHandler.handle({ url: a, request: r, event: n })
                                          )
                                        case 14:
                                          throw i
                                        case 15:
              ...
              value: function (e) {
                ...
                try {
                  for (s.s(); !(t = s.n()).done; ) {
                    var c = t.value,
                      o = void 0,
                      u = c.match({ url: r, sameOrigin: n, request: a, event: i })
                    if (u)
                      return (
                        (o = u),
            ...
            },
            {
              ...
              value: function (e) {
                if (!this._routes.has(e.method))
                  throw new d('unregister-route-but-not-found-with-method', { method: e.method })
      ...
      De = function () {
        return Ee || ((Ee = new Se()).addFetchListener(), Ee.addCacheListener()), Ee
      }
    function Pe(e, t, r) {
      var n
      if ('string' === typeof e) {
          ...
          for (;;)
            switch ((g.prev = g.next)) {
              ...
              case 8:
                ...
                return ((f = new URL(h.href)).pathname += i), (g.next = 13), f.href
              case 13:
                if (!c) {
                  g.next = 18
                  break
                }
                return ((l = new URL(h.href)).pathname += '.html'), (g.next = 18), l.href
              case 18:
                if (!o) {
                  g.next = 37
                  break
          ...
          function (t) {
            ...
            try {
              for (s.s(); !(r = s.n()).done; ) {
                var c = r.value,
                  o = i.get(c)
                if (o) return { cacheKey: o, integrity: e.getIntegrityForCacheKey(o) }
              }
            } catch (u) {
              s.e(u)
            } finally {
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                [],
                                (n = r.fetchAndCachePut(t).catch(function () {})),
                                r.waitUntil(n),
                                (e.next = 6),
                                r.cacheMatch(t)
                              )
                            ...
                            case 15:
                              ...
                              break
                            case 18:
                              ;(e.prev = 18), (e.t0 = e.catch(12)), e.t0 instanceof Error && (i = e.t0)
                            case 21:
                              if (a) {
                                e.next = 24
                                break
                              }
                              throw new d('no-response', { url: t.url, error: i })
                            case 24:
                              return e.abrupt('return', a)
                            case 25:
                            case 'end':
    ...
    self.addEventListener('activate', function () {
      ...
      (function (e) {
        ...
        { revision: 'cb7eec09181086cc81741de301f99d29', url: '/index.html' },
        { revision: null, url: '/static/css/main.eb30a7b3.css' },
        { revision: null, url: '/static/js/787.28cb0dcd.chunk.js' },
        { revision: null, url: '/static/js/main.09e84d3c.js' },
        { revision: null, url: '/static/media/Comfortaa-Bold.059cc3e0c5d00a88354f.ttf' },
        { revision: null, url: '/static/media/Poppins-Black.d8b850b920a5ef49d752.ttf' },
        { revision: null, url: '/static/media/Poppins-Bold.cdb29a5d7ccf57ff05a3.ttf' },
        { revision: null, url: '/static/media/Poppins-SemiBold.ac8d04b620e54be9b0f0.ttf' },
        { revision: null, url: '/static/media/Roboto-Bold.f80816a5455d171f948d.ttf' },
        { revision: null, url: '/static/media/Roboto-Light.333da16a3f3cc391d087.ttf' },
        { revision: null, url: '/static/media/Roboto-Medium.7c8d04cd831df3033c8a.ttf' },
        { revision: null, url: '/static/media/Roboto-Regular.fc2b5060f7accec5cf74.ttf' },
        { revision: null, url: '/static/media/Roboto-Thin.a732a12eb07742232407.ttf' },
        { revision: null, url: '/static/media/Sofia_Pro_Regular.77be0a74d19c41439637.ttf' },
        {
          revision: '41f151364f3d6954425e5fd39318ecf7',
          url: '/static/media/agenda-arrow-icon-right.81c84c4a39ea91b82499c9e945ed0cbc.svg',
        },
        {
          revision: '1d222eeea097a6e4b991a42dbacd7077',
          url: '/static/media/agenda-logo-color.cb0ce09dcc5b97c18eb5755c559acc2a.svg',
        },
        {
          revision: '41da1e22e1f2f566fb30e534b0f281f0',
          url: '/static/media/app-header-background.9967ce8a4a6348e4b69fef932045df88.svg',
        },
        {
          revision: 'afaec99a04ec0dcda2c99a170f827177',
          url: '/static/media/board-icon.286a8829cbf9c0b9789123da28c6cb96.svg',
        },
        {
          revision: '719f84072b615e63a6bf716e16b209ca',
          url: '/static/media/board-menu.ccbc36b4756b7a67c7c2d82828c3169c.svg',
        },
        {
          revision: '7fbca4215fcc9f0081ff51f9e5974edd',
          url: '/static/media/board.9f7cc2a25bf3472a42bed3a0ca263b28.svg',
        },
        {
          revision: 'fb250218763140c417aaa4f588b842e5',
          url: '/static/media/clock.b87316ba0ea13b05dbd86e1fa5b6ba9e.svg',
        },
        {
          revision: '763dd95057c9bb4c02f2b912976b4e1f',
          url: '/static/media/double-arrow-sort.4bb166e25ed0ce7225fd982d5239e33a.svg',
        },
        {
          revision: 'c231ca9f48a29e09c4e4ce0cbae65365',
          url: '/static/media/down-arrow.18aa101ff5fc002ae75d60c7f385b6fe.svg',
        },
        {
          revision: 'c35942ac2025af9dfd85578ce532adeb',
          url: '/static/media/favorites.3dde7be68b423d98f6ddd3c2425e9787.svg',
        },
        { revision: null, url: '/static/media/fist-bump.d0bda9ed55a86a58daac.gif' },
        { revision: null, url: '/static/media/home-bg-img.6c3461523da0a635bd77.jpg' },
        {
          revision: '6cd6a3b35f3f2266256be6fd67caece5',
          url: '/static/media/home-icon.48b276c5e55c7645606730b545a21c0d.svg',
        },
        {
          revision: 'aaa9c71f05c307f85137c75f00237dd6',
          url: '/static/media/img-file.e16097abdc89f4ad63c7647c805be0de.svg',
        },
        {
          revision: 'b59e60b662c1311bbd4d4b0a3f72ca6d',
          url: '/static/media/invite.02c284d2f946c7109db93f67b3236c73.svg',
        },
        {
          revision: '64437bb8c8f89b53ba72d2367310ca9d',
          url: '/static/media/kanban-status.fff8dc489fd497c16fc4ecdcf9bfa654.svg',
        },
        {
          revision: 'bf74f3d246312ce689b2458631d8a12d',
          url: '/static/media/like.2af4a9919d18c0ee172c77d4fbeef8b7.svg',
        },
        {
          revision: 'fb6519d6606e2e5a11427a8e31d8e34b',
          url: '/static/media/logout.6809a8b688011f31630740e440233957.svg',
        },
        {
          revision: 'b5ca029b09029c7ff4cea03811589f15',
          url: '/static/media/menu.0229f4ea866a2c2b9efdd7e84be94ce5.svg',
        },
        {
          revision: 'b29ff05406d51da1bb2e82400a14c951',
          url: '/static/media/my-work.c4d075f3343058177b617bc01c46cfe3.svg',
        },
        {
          revision: '9eede39d1ad29163433d7f417d0bf68c',
          url: '/static/media/new-group-icon.6b1280e12c25be19ebaff96f3fe9ba01.svg',
        },
        {
          revision: 'a939c56115f2f41dc68be732ebe17106',
          url: '/static/media/no-person-icon.368adeac650bc6e311a3ed2e03835556.svg',
        },
        {
          revision: '1b23dc0295dec7a0da7e142a89c2fd52',
          url: '/static/media/pencil.babc9a6c61d11619bef9b32c02366fa6.svg',
        },
        {
          revision: 'e9d1f58b2722e9aa355590f549dde8e2',
          url: '/static/media/person-remove.443565f81ada8d487b1095780163784c.svg',
        },
        {
          revision: '6f1a0044211004c8d7445bd8cd743a20',
          url: '/static/media/plus-icon.df3040059ad46d0a07d3f2958d757396.svg',
        },
        {
          revision: 'f56b44c88f23dc3b41ea577aa153391f',
          url: '/static/media/preson-add.5f625673d5b3593c479e6fb648890431.svg',
        },
        { revision: null, url: '/static/media/profile-img-gal.023e32525ca9c8a2bfae.png' },
        { revision: null, url: '/static/media/profile-img-guest.bbb341260f1d1fc04852.png' },
        { revision: null, url: '/static/media/profile-img-michael.b719b82446707b8ec3d9.png' },
        { revision: null, url: '/static/media/profile-img-or-old.ba07ef4c7bb79de6b4bc.png' },
        { revision: null, url: '/static/media/profile-img-or.c2d64416e959132d32e4.png' },
        { revision: null, url: '/static/media/profile-img-tal.f0f12a70afb67d86d7f0.png' },
        {
          revision: 'af30d0b8058784d0346f269bb7bb2bcb',
          url: '/static/media/reply.2019a38376f21782a1f1a92d094ea088.svg',
        },
        {
          revision: 'c0dc864278db258d6897419142e4a94a',
          url: '/static/media/right-arrow.e7f882a9d837f762c0128e5799ab3e9e.svg',
        },
        {
          revision: '5fd0ee313b8e200b2f45b47aecfd4bde',
          url: '/static/media/search.255a49d3c81f09cd09aff9a02a89db47.svg',
        },
        { revision: null, url: '/static/media/small-bg-img.9c107da81a346d886d51.png' },
        { revision: null, url: '/static/media/sofiapro-light.7978d11b00722a17ccfa.otf' },
        {
          revision: '0dc1804691b5425698625cc1414c2111',
          url: '/static/media/star-clr.9464f5e732ca7dd79f1b3834ab3b04f9.svg',
        },
        {
          revision: '88688cf0265e297262d0cf7470c1609c',
          url: '/static/media/star.6268c6599ec9fe3bb1bc0a28c88c5165.svg',
        },
        {
          revision: 'b9fd2f58a6d2b4fd78f0df2476757a61',
          url: '/static/media/start-conversation-empty.d3fc6195c4963109094f2af5c366f7ba.svg',
        },
        {
          revision: 'b3642f560db2b023c6d43f79e9a00598',
          url: '/static/media/start-conversation.352d0ef7bbf535ffc28f4d9e4f948f88.svg',
        },
        {
          revision: '3710210337bbf7ae00a42d35cdac554a',
          url: '/static/media/status-activity-icon.0498ad5c7b0b27d779beabb66dda0410.svg',
        },
        {
          revision: 'b31ffb70aaaa4fa679627359ac8ed4b9',
          url: '/static/media/timeline-menu.f6120214b08dc33304b64aa1fc56a554.svg',
        },
        {
          revision: '44025f8fc3ce645ed0bfd4383d43b0ca',
          url: '/static/media/trash-icon.fb9fa57caab0f0168273961d33bf5a49.svg',
        },
      ]),
      (function (e) {
        var t = Re()
    ...
    Pe(function (e) {
      var t = e.request,
        r = e.url
      return 'navigate' === t.mode && !r.pathname.startsWith('/_') && !r.pathname.match(We)
    }, ((Me = '/index.html'), Re().createHandlerBoundToURL(Me))),
      Pe(function (e) {
        var t = e.url
        return t.origin === self.location.origin && t.pathname.endsWith('.png')
      }, new Ke({ cacheName: 'images', plugins: [new pe({ maxEntries: 50 })] })),
